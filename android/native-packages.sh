...
KTB
    KT_SRC="$OUT/ChuksBuild.kt $PKGDIR/MainActivity.kt $PKGDIR/ChuksEffects.kt $PKGDIR/ChuksModule.kt $PKGDIR/ChuksJobService.kt $PKGDIR/ChuksLocationService.kt $PKGDIR/ChuksNotifications.kt $PKGDIR/ChuksAudio.kt $PKGDIR/ChuksFiles.kt $PKGDIR/ChuksGeo.kt $PKGDIR/ChuksContacts.kt $PKGDIR/ChuksCalendar.kt $OUT/ChuksPackageModules.kt $PKG_KT"
    KT_CP="$AJAR"
    return 0
}
